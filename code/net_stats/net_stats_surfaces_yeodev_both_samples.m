...
try
    ...
    %take out the NaNs from medial wall labels
    system_connectivity=system_connectivity(2:8,2:8)
...
export(outfile,'File',fullfile(outdir,strcat('n',string(size(subjlist,1)),'_',full_name,'_schaefer400_yeodev_network_stats.csv')),'Delimiter',',')
