...
task_maps_dir=/cbica/projects/spatial_topography/data/imageData/task_maps/hcp_group_task_maps

for file in `find ${task_maps_dir} -iname "*_cohen_c1.dscalar.nii"  -exec basename {} \;`
do

cifti_in=${file}
cifti_in=HCP_S1200_997_tfMRI_ALLTASKS_level2_cohensd_hp200_s2_MSMAll.dscalar.nii
...
final_out_left=${task_maps_dir}/ABCD.${cifti_in%dscalar.nii}.lh.41k_fsavg_L.func.gii
final_out_right=${task_maps_dir}/ABCD.${cifti_in%dscalar.nii}.rh.41k_fsavg_R.func.gii
