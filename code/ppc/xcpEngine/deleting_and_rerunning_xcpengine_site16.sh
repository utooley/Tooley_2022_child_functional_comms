...
output_dir=/data/jux/mackey_group/public_data/ABCD/bids_release2_site16/derivatives/xcpEngine_gsrwmcsf_scrub0.2mm_dropvols_marek
FMRIPREP_DIR=/data/jux/mackey_group/public_data/ABCD/bids_release2_site16/derivatives/fmriprep
COHORT_FILE=${sublist_dir}/rerunning_site16_cohort_again.csv
subjlist=${sublist_dir}/site16_rerun.csv
