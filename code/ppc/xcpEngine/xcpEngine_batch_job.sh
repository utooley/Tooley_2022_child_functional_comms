...
#FULL_COHORT=${sublist_dir}/n597_site14site20_cohort.csv
FULL_COHORT=${sublist_dir}/rerunning_site14site20_again_secondtime_cohort.csv
...
#ALSO REMEMBER TO CHANGE YOUR .SGE_REQUEST FILE FOR MORE MEM, THIS MAY NOT WORK
